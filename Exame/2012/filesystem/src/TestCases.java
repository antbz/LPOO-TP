...
public class TestCases extends TestCase {
	public void testCreateFileSystem() throws DuplicateNameException {
		FileSystem fs = new FileSystem("FAT32");
		assertEquals("FAT32", fs.getType());		
	}

	public void testFileSystemRoot() throws DuplicateNameException {
		FileSystem fs = new FileSystem("FAT32");
	...
	public void testFolderContents() throws DuplicateNameException {
		...
		assertSame(node2, root.getChildByName("readme.txt"));
	}
